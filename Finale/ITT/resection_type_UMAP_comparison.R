...
for (resection_type in c("Maximal Resection", "Biopsy Only")) {
  for (pathway_name in pathways){
    print(pathway_name)
    file_name <- paste0("/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/2TT/Analysis/Aggregate_ge_only/Nextflow/Aggregated/outs/NETZEN_analysis/Finale/ITT/output_file_", pathway_name,  "_", resection_type,"_all_cells.pdf")
