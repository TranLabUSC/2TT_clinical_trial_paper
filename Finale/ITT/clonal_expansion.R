...
clonal_expansion_dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/2TT/Analysis/Aggregate_ge_only/Nextflow/Aggregated/outs/NETZEN_analysis/CD8_clonal_analysis/clonal_expansion_shannon_all_T_cells_division/"
...
file_name <- paste0("shannon_Clonal_Diversity_Ratio_Resection_Type_Comparison.pdf")
...
make_comparison_value_plot(survival_df, "Blood_Pre-TTF_vs_Blood_Post-TTF", diversity_index = "shannon", alternative = "l", plot_dir)
make_comparison_value_plot(survival_df, "Blood_Pre-TTF_vs_Blood_1", diversity_index = "shannon", alternative = "l", plot_dir)
make_comparison_value_plot(survival_df, "Blood_Pre-TTF_vs_Blood_2", diversity_index = "shannon", alternative = "l", plot_dir)
make_comparison_value_plot(survival_df, "Blood_Post-TTF_vs_Blood_1", diversity_index = "shannon", alternative = "l", plot_dir)
make_comparison_value_plot(survival_df, "Blood_Post-TTF_vs_Blood_2", diversity_index = "shannon", alternative = "l", plot_dir)
