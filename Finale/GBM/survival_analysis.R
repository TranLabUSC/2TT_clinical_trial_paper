...
covariates <- c("Age", "Sex", "MGMT.methylation", "Extension.of.resection..Biopsy.only..Partial..GTR.")
cox_ph_result <- get_cox(cox_input_df, "OS.from.enrollment..months.", "Dead", covariates)
...
covariates <- cox_input_df[, c("Age", "Sex", "MGMT.methylation", "Extension.of.resection..Biopsy.only..Partial..GTR.")]
...
updated_survival_df <- updated_survival_df[updated_survival_df$IDH.1.mutation == "negative",]
